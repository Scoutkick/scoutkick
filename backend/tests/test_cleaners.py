...
class TestCleanerBase(unittest.TestCase):
    def setUp(self):
        self.all = {s: BaseCleaner.get_cleaner(s) for s in ["2019", "2020", "2021", "2022", "2023", "2024", "2025"]}
    ...
    def test_missing_fields_default_to_zero(self):
        c = BaseCleaner.get_cleaner("2019")
        r = c.clean({})
        for i in range(10):
...
class TestCleaner2024(TestCleanerBase):
    def test_endgame_is_composite_sum(self):
        c = BaseCleaner.get_cleaner("2024")
...
class TestCleaner2025(TestCleanerBase):
    def test_bool_fields_convert_to_float(self):
        c = BaseCleaner.get_cleaner("2025")
